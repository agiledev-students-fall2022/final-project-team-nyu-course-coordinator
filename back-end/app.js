...
//   app.get('*', (req, res) =>
//     res.sendFile(
//       path.resolve(dirname, '../', 'client', 'build', 'index.js')
//     )
//   );
// } else {
//   app.get('/', (req, res) => res.send('Please set to production'));
// }
// const CONNECTION_URL = 'mongodb+srv://qlaueen:M1lalamml@closetapp-cl.glmb4ny.mongodb.net/?retryWrites=true&w=majority';
